...
with(this){return _c('p',[_v("If more than one valid prefix "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-all")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-name")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-id")]),_v(", or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("stats")]),_v(" are present, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommandParser")]),_v(" creates "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommands")]),_v(" in the following order of precedence:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("all")]),_v(" > "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("name")]),_v(" > "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("id")]),_v(" > "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("stats")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Aspect: How to check which command to execute:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Goes through checks for presence of prefix variants, and execute the first detected based on the precedence of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-all")]),_v(" > "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-name")]),_v(" > "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-id")]),_v(" > "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-stats")])]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: If variants increase in the future, might take extra time falling through the conditional checks. Precedence of prefixes can also not be aligned with what the user intended.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Executes all variants given in the command\nitself.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: More intuitive for user, gives quick overview of multiple view commands.")]),_v(" "),_c('li',[_v("Cons: Difficult to implement and requires drastic changes in GUI.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Below is an example usage scenario where the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view -stats")]),_v(" command was entered.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The mechanism is similar to list feature in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(". parser checks for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-all")]),_v(" flag and execute showing the entire list of students.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1:")]),_v(" In a view command class with view -id/-name.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Clear execution line.")]),_v(" "),_c('li',[_v("Cons: Several if else checks, more prone to errors.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2 (current choice) :")]),_v(" Separate classes for view -all and other view commands")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement, less merge conflicts.")]),_v(" "),_c('li',[_v("Cons: More files and parsers needed.")])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("It's mechanism is similar to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("help")]),_v(" feature where a popout window is shown when called.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("It gets it's info from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("logic")]),_v(" interface")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"view-name-feature"}},[_v("View Name Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#view-name-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"view-id-feature"}},[_v("View ID Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#view-id-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h1',{attrs:{"id":"student-payment-management-system"}},[_v("Student Payment Management System"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#student-payment-management-system","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h2',{attrs:{"id":"add-payment-feature"}},[_v("Add Payment Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#add-payment-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h2',{attrs:{"id":"mark-payment-feature"}},[_v("Mark Payment Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#mark-payment-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h2',{attrs:{"id":"reset-payments-feature"}},[_v("Reset Payments Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#reset-payments-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"implementation-9"}},[_v("Implementation"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#implementation-9","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"features-overview-2"}},[_v("Features Overview"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#features-overview-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TuteeTally")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view details of students either by listing all or searching by name or ID.")])]),_v(" "),_c('li',[_c('p',[_v("TuteeTally retrieves and shows the relevant student details based on the request.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Mon, 15 Apr 2024, 14:48:06 GMT+8]")])])])}
}];
