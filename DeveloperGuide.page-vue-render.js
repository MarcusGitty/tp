...
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Core")]),_v(" "),_c('ul',[_c('li',[_v("Files like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Config")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("GuiSettings")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogsCenter")])])])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Exceptions")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Util")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Step 3:")]),_v(" All checks for prefixes return false, and falls into the default case. A "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("isStatsCommand")]),_v(" set to true is returned")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User initiates the command to add a student by providing the student's name, address, contact number, subject, and level.")])]),_v(" "),_c('li',[_c('p',[_v("The AddressBook processes the provided information, adds the student particulars into the system, and assigns a unique ID to the student.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays a confirmation message along with the details of the newly added student at the top of the list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User inputs the command in an incorrect format.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. AddressBook shows an error message and the correct command format.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("1b. User enters a name that already exists in the AddressBook.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. AddressBook generates and assigns a unique ID to the new student to avoid duplication.")])]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])]),_v(" "),_c('li',[_c('p',[_v("1c. User omits a required field in the command.")]),_v(" "),_c('ul',[_c('li',[_v("1c1. AddressBook shows an error message indicating the missing field.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view details of students either by listing all or searching by name or ID.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook retrieves and shows the relevant student details based on the request.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The requested student does not exist or the list is empty.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. AddressBook displays a message indicating no such student exists or the list is empty.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2b. User inputs an incorrect command format for viewing details.")]),_v(" "),_c('ul',[_c('li',[_v("2b1. AddressBook shows an error message and the correct command format.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view summary statistics of students.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook processes the request and displays the total number of students along with other relevant statistics.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. There is an error in processing the request.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. AddressBook displays an error message in red.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list Student")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of Student")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific Student in the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook deletes the Student")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Sun, 14 Apr 2024, 17:40:05 GMT+8]")])])])}
}];
