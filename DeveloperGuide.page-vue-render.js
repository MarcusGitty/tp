...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" In a view command class with view -id/-name.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Clear execution line.")]),_v(" "),_c('li',[_v("Cons: Several if else checks, more prone to errors.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Separate classes for each view command")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement, less merge conflicts.")]),_v(" "),_c('li',[_v("Cons: Large number of files and parsers needed.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Mon, 8 Apr 2024, 20:59:55 GMT+8]")])])])}
}];
