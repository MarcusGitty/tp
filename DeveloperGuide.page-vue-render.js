...
with(this){return _c('ol',[_c('li',[_v("Update Edit command to use ID instead of index.")]),_v(" "),_c('li',[_v("Improve the UI such as removing all white spaces from it.")]),_v(" "),_c('li',[_v("Learning styles can be tagged to Person so that it doesn't need to be logged every lesson.")]),_v(" "),_c('li',[_v("Logging of a lesson will automatically update the payment info.")]),_v(" "),_c('li',[_v("View -id or -name should automatically filter and show the exams of the person on the right.")]),_v(" "),_c('li',[_v("Checking of duplicate persons.")]),_v(" "),_c('li')])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Sun, 14 Apr 2024, 22:27:27 GMT+8]")])])])}
}];
